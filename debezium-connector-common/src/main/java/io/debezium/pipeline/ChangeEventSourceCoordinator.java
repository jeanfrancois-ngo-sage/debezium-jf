...
public class ChangeEventSourceCoordinator<P extends Partition, O extends OffsetContext> {
    ...
    public void commitOffset(Map<String, ?> partition, Map<String, ?> offset) {
        try {
            ...
            LOGGER.debug("Requesting offset commit to streaming source: partition={}, offset keys={}", partition, offset.keySet());
            streamingSource.commitOffset(partition, offset);
            LOGGER.debug("Offset commit request completed successfully");
        }
        catch (Throwable e) {
